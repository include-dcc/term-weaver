# Contributing to cam-expanded-enums

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
cam-expanded-enums. These guidelines are not strict rules.
...
The cam-expanded-enums team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the cam-expanded-enums technical leads
...
[issues]: https://github.com/include-dcc/cam-expanded-enums/issues/
[pulls]: https://github.com/include-dcc/cam-expanded-enums/pulls/
